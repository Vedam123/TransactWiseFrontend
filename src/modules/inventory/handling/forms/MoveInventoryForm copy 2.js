...
export default function MoveInventoryForm() {
  ...
  const handleSubmitButtonClick = async () => {
    try {
      ...
      const formDataWithIntIds2 ={
        ...
        target_bin_id: parseInt(formData.target_bin_id, 10),
        target_rack_id: parseInt(formData.target_rack_id, 10),
        target_row_id: parseInt(formData.target_row_id, 10),
        target_aisle_id: parseInt(formData.target_aisle_id, 10),
        target_zone_id: parseInt(formData.target_zone_id, 10),
        target_location_id: parseInt(formData.target_location_id, 10),
        target_warehouse_id: parseInt(formData.target_warehouse_id, 10)
      }

      console.log(formDataWithIntIds);
      console.log(formDataWithIntIds2)
  ...
  const handleCloseTargetBinForm = async () => {
  ...
  return (
    <div className="child-container menu-container">
      ...
      <div className="child-container form-container">
            ...
            <div className="form-group col-md-6 mb-2">
              <div className="form-row">
                <button
                  ...
                  onClick={handleCloseTargetBinForm}
                >
                  Move To ?
                </button>
              </div>
        ...
        {/* Button to call the POST API */}
        {targetForm && ( <div className="form-group col-md-6 mb-2">
          <div className="form-row">
            <button
              type="button"
