...
const HELP_CommonPage = () => (
  <div>
    ...
    <p className="indented-paragraph">
      Using this menu item, one can create, update, delete, and view Legal entities.
    </p>

    <h3 className="subheading">Companies</h3>
    <p className="indented-paragraph">
      Manage and view information related to companies.
    </p>

    <h3 className="subheading">Departments</h3>
    <p className="indented-paragraph">
      Handle information about different departments within the organization.
    </p>

    <h3 className="subheading">Group Companies</h3>
    <p className="indented-paragraph">
      View and manage information about group companies within the organization.
    </p>
  </div>
);
