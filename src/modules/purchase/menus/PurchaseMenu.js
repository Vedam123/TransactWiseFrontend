...
export default function PurchaseModuleMenu() {
  ...
  const menuItems = [
    { path: "/purchase-requisition", text: "Purchase Requisition" },
    { path: "/purchase-rfq", text: "Request Quotation" },
    { path: "/purchase-order", text: "Purchase Orders" },
